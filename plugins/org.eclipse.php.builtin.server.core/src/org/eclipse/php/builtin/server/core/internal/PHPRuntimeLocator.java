...
public class PHPRuntimeLocator extends RuntimeLocatorDelegate {
	...
	protected static final String[] runtimeTypes = new String[] { "org.eclipse.php.server.runtime.54",
			"org.eclipse.php.server.runtime.55", "org.eclipse.php.server.runtime.56",
			"org.eclipse.php.server.runtime.70", "org.eclipse.php.server.runtime.71" };
		...
		for (int i = 0; i < runtimeTypes.length; i++) {
			try {
				...
				if (status == null || status.getSeverity() != IStatus.ERROR)
					return runtime;
				Trace.trace(Trace.FINER, "False runtime found at " + absolutePath + ": " + status.getMessage());
			} catch (Exception e) {
